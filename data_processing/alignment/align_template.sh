...
cd /export/b08/nbafna1/projects/courses/601.764-multilingual-nlp/hw1/using_awesome-align
...
python3 ~/misc/alignment/format_raw.py $source_file $target_file $INFILE # This code creates the $INFILE using text.txt and du.txt
...
python3 ~/misc/alignment/read_alignments.py $INFILE $ALIGN_FILE $OUTFILE